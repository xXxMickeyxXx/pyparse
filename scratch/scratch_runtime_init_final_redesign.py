...
def final_main():
	...
	__PARSER__ = CoreParser3(init_state=0, grammar=__GRAMMAR__, parse_table=None, debug_mode=False, parser_id="[ • --- • CoreParser3 • ---• ]")
	...
	_result_text_out = bold_text(apply_color(11, f"\t{_INPUT_}")) + "\n\n\t |\n\t |\n\t |\n\t • -----> " + underline_text(bold_text((apply_color(10, "!VALID!") if _parse_result else apply_color(9, "!INVALID!"))))
	print()
